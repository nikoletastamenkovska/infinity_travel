...
export const CardExotic: React.FC<ArrangementType> = (arrangement) => {
      ...
      <div className={`card flex-fill h-100 ${styles.styled_card}`}>
        ...
        <div className="card-body container">
            ...
            <div className="row mx-0">
              <div className={`col-7 py-2 px-0 ${styles.grey_text}`}>
                <div className={styles.small_font}>
                  {arrangement.AvailabilityDates[0].NumberOfDays} ноќевања/наем
                  соба
                </div>
                <div className={styles.small_font}>
              ...
              <div className="col-5 py-2 pe-0 text-end">
          ...
          <button
            ...
            onClick={() => {
              const exoticId = arrangement.Id;
              router.push({
                pathname: `/exotic_products/${exoticId}`,
                query: {
                  Id: exoticId,
                },
              });
